      ...
      >
        ...
        >
          ...
          {category === ManagementCard && (
            ...
            >
              <Text variant={getTextSize(size)} classes={`font-bold`}>
                {player.Position}
                {player.PositionTwo ? `/${player.PositionTwo}` : ""}
              </Text>
            </div>
          )}
          {category === Formations && (
          ...
          {(position === "STU" || position === "KR" || position === "PR") && (
            <div
              className="absolute top-4 left-0 px-1 py-0.5 rounded-bl-lg rounded-tl-lg z-10"
              style={{ backgroundColor: "rgba(0,0,0,0.8)" }}
            >
              <Text variant={getTextSize(size)} classes={`font-semibold`}>
                {player.Position}
