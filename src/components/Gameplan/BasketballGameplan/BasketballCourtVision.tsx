    ...
    >
      ...
      >
        ...
        >
          <g
            id="hardwood-planks"
            data-name="Hardwood plank outlines"
            fill="none"
            stroke="#8f6238"
            strokeWidth="0.25"
            opacity="0.42"
          >
            {[
              3.5, 6, 9, 12, 15, 18, 21, 24, 27, 30, 33, 36, 39, 42, 45, 48, 51,
              54, 57, 60, 63, 66, 69, 72, 75, 78, 81, 84, 87, 90, 93, 96, 98,
            ].map((x) => (
          ...
          <path
            id="three-point-line"
            data-name="Three-point line"
            d="M 18.75 1 L 18.75 43.75 A 31.25 31.25 0 0 0 81.25 43.75 L 81.25 1"
            fill="none"
            stroke="black"
            strokeWidth="1.2"
          />
          ...
          <circle
            id="free-throw-circle"
            data-name="Free-throw circle"
            cx="50"
            cy="51"
            r="10"
            fill="none"
          ...
          return (
            ...
            >
              ...
              >
                    ...
                    <span
                      className={
                        league === SimCBB
                          ...
                          : getProOverallColor(player.Overall)
                      }
                    >
                      {league === SimCBB
                        ? getCBBLetterGrade(player.Overall, player.Year)
                ...
                {player && league === SimCBB && (
                  <div className="absolute right-0 top-6 rounded-l-md bg-black/85 px-1.5 py-0.5 text-xs font-semibold text-white">
      ...
      >
        ...
        <h1
          className="font-sans antialiased text-4xl font-semibold uppercase text-white sm:text-5xl"
          style={{
            textShadow:
