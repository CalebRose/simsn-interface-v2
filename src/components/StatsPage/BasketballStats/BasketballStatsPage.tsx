...
import { useBasketballStats } from "./useBasketballStatsPage";
...
import { Help1, SimNBA } from "../../../_constants/constants";
    ...
    <>
      ...
      <div className="grid grid-flow-row grid-auto-rows-auto w-full h-full max-[1024px]:grid-cols-1 max-[1024px]:gap-y-2 grid-cols-[minmax(200px,2fr)_10fr] max-[1024px]:gap-x-1 gap-x-2 mb-2">
        <StatsSidebar
          ...
          basketballStatsType={basketballStatsType}
          ChangeBasketballStatsType={ChangeBasketballStatsType}
          gameType={gameType}
