...
export const BootstrapService = {
  ...
  GetFBAPlayerBootstrapData: async (
    collegeID: number,
    proID: number,
  ): Promise<FBPlayerBootstrap> => {
    return await GetCall<FBPlayerBootstrap>(
      `${fbaUrl}bootstrap/players/${collegeID}/${proID}`,
    );
  },
  ...
  GetHCKStatsBootstrapData: async (
    collegeID: number,
    proID: number,
  ): Promise<any> => {
    return await GetCall<any>(`${hckUrl}bootstrap/stats/${collegeID}/${proID}`);
  },
