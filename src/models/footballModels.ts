...
export class NFLPlayerSeasonStats {
  ...
  constructor(source: any = {}) {
    ...
    this.DefensivePressures = source["DefensivePressures"];
    this.Hurries = source["Hurries"];
    this.PassRushSnaps = source["PassRushSnaps"];
    this.PassRushWins = source["PassRushWins"];
    this.PressuresAllowed = source["PressuresAllowed"];
    this.PassBlockSnaps = source["PassBlockSnaps"];
    this.PassBlockWins = source["PassBlockWins"];
...
export class NFLTeamSeasonStats {
  ...
  constructor(source: any = {}) {
    ...
    this.Safeties = source["Safeties"];
    this.DefensivePressures = source["DefensivePressures"];
    this.DefensiveExpectedSacks = source["DefensiveExpectedSacks"];
    this.ExtraPointsMade = source["ExtraPointsMade"];
    this.ExtraPointsAttempted = source["ExtraPointsAttempted"];
...
export class BootstrapData {
  ...
  constructor(source: any = {}) {
    ...
    this.AllCollegeTeams =
      this.convertValues(source["AllCollegeTeams"], CollegeTeam) || [];
    this.CollegeStandings =
    ...
    this.CollegeNotifications =
      this.convertValues(source["CollegeNotifications"], Notification) || [];
    this.AllCollegeGames =
      this.convertValues(source["AllCollegeGames"], CollegeGame) || [];
    this.CollegeGameplan =
      this.convertValues(source["CollegeGameplan"], CollegeGameplan) || null;
    this.CollegeDepthChart =
      this.convertValues(source["CollegeDepthChart"], CollegeTeamDepthChart) ||
      null;
    this.CollegeDepthChartMap =
      this.convertValues(
    ...
    this.ProStandings =
      this.convertValues(source["ProStandings"], NFLStandings) || [];
    ...
    this.ProNotifications =
      this.convertValues(source["ProNotifications"], Notification) || [];
    this.AllProGames = this.convertValues(source["AllProGames"], NFLGame) || [];
    this.NFLGameplan =
      this.convertValues(source["NFLGameplan"], NFLGameplan) || null;
    this.NFLDepthChart =
      this.convertValues(source["NFLDepthChart"], NFLDepthChart) || null;
    this.NFLDepthChartMap =
      this.convertValues(source["NFLDepthChartMap"], NFLDepthChart, true) ||
      null;
...
export class PlayByPlayResponse {
  ...
  constructor(source: any = {}) {
    ...
    this.Qb = source["Qb"];
    this.Back1 = source["Back1"];
    this.Back2 = source["Back2"];
    this.Back3 = source["Back3"];
    ...
    this.Ldt = source["Ldt"];
    this.Lde = source["Lde"];
    this.Rolb = source["Rolb"];
    this.Rilb = source["Rilb"];
    this.Mlb = source["Mlb"];
    this.Lilb = source["Lilb"];
    this.Lolb = source["Lolb"];
    this.Rcb = source["Rcb"];
    this.Extradb1 = source["Extradb1"];
    this.Extradb2 = source["Extradb2"];
    this.Extradb3 = source["Extradb3"];
    this.Fs = source["Fs"];
    this.Ss = source["Ss"];
    this.Lcb = source["Lcb"] ?? source["Fcb"];
    this.Blitzer1 = source["Blitzer1"];
    this.Blitzer2 = source["Blitzer2"];
    this.Blitzer3 = source["Blitzer3"];
  }
}
...
export class BootstrapPlayerData {
  CollegeRosterMap: { [key: number]: CollegePlayer[] } | null;
  CollegeInjuryReport: CollegePlayer[];
  ProRosterMap: { [key: number]: NFLPlayer[] } | null;
  ProInjuryReport: NFLPlayer[];
  ...
  constructor(source: any = {}) {
    ...
    this.PracticeSquadPlayers =
      this.convertValues(source["PracticeSquadPlayers"], NFLPlayer) || [];
  }
