...
export const attributeAverages: Attributes = {
  Speed: {
    ...
    STU: { mean: 40, stddev: 10 },
    KR: { mean: 40, stddev: 10 },
    PR: { mean: 40, stddev: 10 },
  },
  FootballIQ: {
  ...
  Stamina: {
    ...
    STU: { mean: 50, stddev: 15 },
    KR: { mean: 50, stddev: 15 },
    PR: { mean: 50, stddev: 15 },
  },
  Injury: {
    C: { mean: 50, stddev: 15 },
    CB: { mean: 50, stddev: 15 },
